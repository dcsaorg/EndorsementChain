...
@DataJpaTest
class TransferBlockRepositoryTest {
    ...
    @Test
    void testSaveTDT() throws java.text.ParseException, com.fasterxml.jackson.core.JsonProcessingException {
...
//         Assertions.assertEquals(tdt.get().previousTransferBlockHash(), null);
    ...
    @Test
    void testAddingPlatformSignature() throws java.text.ParseException, com.nimbusds.jose.JOSEException, java.security.NoSuchAlgorithmException {
