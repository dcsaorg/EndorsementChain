...
public class TransportDocumentTransferRepositoryTest {
    ...
    public void testSaveTDT() throws java.text.ParseException, com.fasterxml.jackson.core.JsonProcessingException {
        repository.save(new TransportDocumentTransfer(blockHash, null, transferBlock, "current"));
        Optional<TransportDocumentTransfer> tdt = repository.findById(blockHash);
    ...
    public void testAddingPlatformSignature() throws java.text.ParseException, com.nimbusds.jose.JOSEException, java.security.NoSuchAlgorithmException {
        TransportDocumentTransfer tdt = new TransportDocumentTransfer(blockHash, null, transferBlock, "current");
